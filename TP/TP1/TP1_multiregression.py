...
# On convertit en tenseurs, cette fois avec plusieurs features
X = torch.tensor(
    df[
        [
            "Square_Footage",
...
class MultilinearRegression(torch.nn.Module):
    def __init__(self, num_features):
        ...
        )  # On a maintenant plusieurs poids, un par feature d'entrée
        self.bias = torch.nn.Parameter(torch.randn(1))  # Toujours un seul biais
